...
<div class="wbc__com-content-wbcaccordion" itemscope itemtype="https://schema.org/Blog">
    ...
    <?php if ($beforeDisplayContent || $afterDisplayContent || $this->params->get('show_description', 1) || $this->params->def('show_description_image', 1)) : ?>
        <div class="wbc__category-desc clearfix">
    ...
    <?php if (!empty($this->lead_items)) : ?>
        <div class="wbc__com-content-category-accordion__items wbc__accordion-blog--items accblog-items <?php echo $this->params->get('blog_class_leading'); ?>">
            <?php foreach ($this->lead_items as &$item) : ?>
                <div class="wbc__com-content-category-accordion__item accblog-item" itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
                    ...
                    <?php $customfields = FieldsHelper::getFields('com_content.article', $this->item); ?>
                    <?php $wbclayoutCustomfields = new JLayoutFile('joomla.content.wbccustomfields', $basePath = null); ?>
                    <?php $wbcCustomfields  = $wbclayoutCustomfields->render($customfields); ?>
                    
                    <?php echo $this->loadTemplate('item');?>
                    <?php //echo $wbcCustomfields; ?>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
   ...
   <?php /* Intro Items als Accordion --------------------------------*/ ?>
    <?php if (!empty($this->intro_items)) : ?>
        ...
        <?php endif; ?>
        <div id="<?php echo $accId;?>" class="wbc__com-content-category-accordion__items accordion wbc__accordion-items<?php echo $blogClass; ?>">
        <?php foreach ($this->intro_items as $key => &$item) : ?>
            ...
            <div class="wbc__com-content-category-accordion__item accordion-item"
                itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
                    ...
                    <?php $wbclayoutAccTitle = new JLayoutFile('joomla.content.wbcacc_style_default_item_title', $basePath = null); ?>
                    <?php echo $wbclayoutAccTitle->render($this->item); ?>
                   
                    <div id="collapse-<?php echo $this->item->id;?>" class="accordion-collapse collapse <?php echo ($count_items == 1 && $collapse_first_item) ? 'show' :'';?>" data-bs-parent="<?php echo $accId;?>">
    ...
    <?php if ($this->maxLevel != 0 && !empty($this->children[$this->category->id])) : ?>
        <div class="wbc__com-content-category-accordion__children cat-children mt-5">
